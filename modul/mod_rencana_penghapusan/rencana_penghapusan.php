...
$aksi="modul/mod_rencana_penghapusan/aksi_rencana_penghapusan.php";
switch($_GET[act]){
  // Tampil Tag
  default:
?>
		...
		<div class="page-content">
			...
			<div class="breadcrumb-line">
				<ul class="breadcrumb">
					...
					<li><a href="?module=rencana_penghapusan">Pendataan Rencana penghapusan</a></li>
				</ul>
            ...
            <div class="tabbable page-tabs">
                <ul class="nav nav-tabs">
                    ...
                    <li><a href="?module=rencana_penghapusan&act=tambahrencana_penghapusan"><i class="icon-plus"></i> Tambah Data</a></li>
                </ul>
                	...
                	<div class="tab-pane active fade in" id="inside">
			           ...
			           <!-- Datatable with custom column filtering -->
			            <div class="panel panel-default">
			                <div class="panel-heading"><h6 class="panel-title"><i class="icon-table"></i> Data Rencana Penghapusan</h6></div>
			                <div class="datatable-add-row">
				                <table class="table">
				                    ...
				                    <tbody>
<?php
                                                                                         $tampil = mysql_query("SELECT * FROM rencana_penghapusan, barang, subdinas where rencana_penghapusan.kode_barang=barang.kode_barang AND rencana_penghapusan.skpd=subdinas.kode_subdinas order by kode_rencana DESC") or die (mysql_error());
  $no=1;
    while ($r=mysql_fetch_array($tampil)){
?>
											<tr>
                                            <td><?php echo"$no"; ?></td>
                                            <td><?php echo"$r[kode_rencana]"; ?></td>
                                            <td><?php echo"$r[nama_subdinas]"; ?></td>
                                            <td><?php echo"$r[kode_barang]"; ?></td>
                                            <td><?php echo"$r[nama_barang]"; ?></td>
                                            <td><?php echo"$r[jumlah]"; ?></td>
                                            <td><?php echo"$r[kondisi]"; ?></td>
				                            <td><center><?php echo"<a href=?module=rencana_penghapusan&act=editrencana_penghapusan&id=$r[kode_rencana]>"; ?><span class="icon-quill2"></span> </a> &nbsp; <?php echo"<a href=$aksi?module=rencana_penghapusan&act=hapus&id=$r[kode_rencana]"; ?> <span class="icon-remove4"></span> </a> &nbsp; </center></td>
				                        </tr>
                                        <?php $no++; } ?>
  ...
  // Form Tambah Tag
  case "tambahrencana_penghapusan":
?>
		<div class="page-content">
			...
			<div class="breadcrumb-line">
				<ul class="breadcrumb">
					<li><a href="?module=home">Home</a></li>
					<li><a href="#">Master</a></li>
					<li><a href="?module=rencana_penghapusan">Setup Rencana penghapusan</a></li>
					<li><a href="?module=rencana_penghapusan&tambahrencana_penghapusan">Tambah Rencana penghapusan</a></li>
				</ul>
...
<div class="alert alert-success fade in block-inner">
                    		<button type="button" class="close" data-dismiss="alert">×</button>
                    		Data berhasil di tambahkan ke database  .... <a href="media.php?module=rencana_penghapusan">lihat data rencana_penghapusan</a>
                    	</div><?php } ?>

		    <!-- Form validation -->
            <form action="<?php echo"$aksi?module=rencana_penghapusan&act=input"; ?>"  method="post" enctype="multipart/form-data" class="form-horizontal validate" role="form">
	            <div class="block">
	                <h6 class="heading-hr"><i class="icon-checkmark-circle"></i> Form Tambah Rencana penghapusan</h6>
...
<?php
  ...
  // Form Edit Kategori  
  case "editrencana_penghapusan":
    $edit=mysql_query("SELECT * FROM rencana_penghapusan, barang, subdinas where rencana_penghapusan.kode_barang=barang.kode_barang AND rencana_penghapusan.skpd=subdinas.kode_subdinas AND kode_rencana='$_GET[id]'");
		...
		<div class="page-content">
			...
			<div class="breadcrumb-line">
				<ul class="breadcrumb">
					...
					<li><a href="#">Master</a></li>
					<li><a href="?module=rencana_penghapusan">Setup Rencana penghapusan</a></li>
					<li><a href="#">Update Rencana penghapusan</a></li>
				</ul>
		    ...
		    <!-- Form validation -->
            <form class="form-horizontal validate" method="post" action="<?php echo"$aksi?module=rencana_penghapusan&act=update"; ?>" enctype="multipart/form-data"  role="form">
	            <div class="block">
	                <h6 class="heading-hr"><i class="icon-checkmark-circle"></i> Form Update Rencana penghapusan</h6>


<div class="form-group">
											
											  <div class="col-lg-6">
												<label for="kode_barang" class="req">Kode Rencana penghapusan </label>
											  <input name="id" type="text" class="form-control" id="id" value="<?php echo"$r[kode_rencana]"; ?>" readonly data-parsley-required="true" >								
                               				  </div>
