	...
	<div class="page-header">
			...
			<div class="breadcrumb-line">
				<ul class="breadcrumb">
					...
					<li><a href="?module=pemeliharaana">Pemeliharaan Gedung dan Tanah</a></li>
				</ul>
			...
			$sql = mysql_query("SELECT * FROM invesc, barang, subdinas where invesc.skpd=subdinas.kode_subdinas and barang.kode_barang=invesc.kode_barang  and subdinas.kode_subdinas = '$_SESSION[dinas]' and id_invesc='$id' order by invesc.id_invesc  DESC, invesc.register DESC") or die(mysql_error('koneksi gagal'));
			...
			?>
			<form method="post" action="modul/mod_pemeliharaanc/aksi_pmlc.php" role="form">
				<div class="block">
				<h6 class="heading-hr"><i class="icon-checkmark-circle"></i> Form Pemeliharaan Gedung dan Tanah</h6>
				<div class="row">
					<div class="col-xs-6">
						<div class="form-group">
								...
								<input type="hidden" name="id_invesc" id="id_invesc" class="form-control" value="<?= $data['id_invesc']?>" readonly required>
						</div>
						<div class="form-group">
                    ...
                    <table class="table">
						...
						?>
							<tr>
								...
								<td>
									<a href="./modul/mod_pemeliharaanc/hapus.php?id=<?=$row[id_pemeliharaan]; ?>" onclick="return confirm('Anda Yakin ingin menghapus data ?');"><span class="icon-remove4"></span> </a>
								</td>
							</tr>    
						</tbody>
						<?php 
