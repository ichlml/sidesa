...
$aksi="modul/mod_laporand/aksi_laporand.php";
      ...
      <div class="panel-body">
        <form method="get" role="form">
            <!-- <input type="hidden" name="act" value="cari"  /> -->
                      <input type="hidden" name="module" value="laporanD"  />
              <div class="block">
                  <div class="row">
                          <div class="col-md-6">
...
if ($_SESSION['level']=='admin' OR $_SESSION[upt]){ 
    ...
    where a.skpd like '$skpd' and a.tanggal_pembelian <= '$_SESSION[tgl1]' and e.kode_barang is null and e.id_inves is null)  as x
     ...
     $jmldata=mysql_num_rows(mysql_query("SELECT a.id_invesd, a.skpd, a.kode_barang, b.nama_barang, c.nama_subdinas,a.panjang, a.lebar, a.luas, a.sumber_dana, a.tanggal_pembelian,  a.jumlah,( a.harga+ ifnull(d.harga,0)) as harga, (a.jumlah* (a.harga+ifnull(d.harga,0))) as total,  a.keterangan FROM invesd a 
     Inner join barang b on a.kode_barang=b.kode_barang
     Left join (select id_inves, kode_barang, sum(nilai) as harga from tb_pemeliharaan where tgl_documen<='$_SESSION[tgl1]' group by id_inves, kode_barang) d on a.kode_barang=d.kode_barang and a.id_invesd=d.id_inves
     left join (select id_inves, kode_barang from penghapusan where tgl_sk<='$_SESSION[tgl1]') e on  a.kode_barang=e.kode_barang and a.id_invesd=e.id_inves
     Inner join subdinas c on a.skpd=c.kode_subdinas
...
// $d=mysql_fetch_array($aaaa); 
		    ...
		    // $jmldata=mysql_num_rows(mysql_query("SELECT * FROM invesd $dinnassa "));
...
?>            <div class="form-actions text-right">
				 ...
				 if ($_SESSION['level']=='admin' OR $_SESSION[upt]){ 
?>
                     	<a href="modul/mod_laporand/excel.php"><input type="submit" value="Eksport to Excel" class="btn btn-primary"></a> 
<?php } else { ?>
  <a href="modul/mod_laporand/excel.php"><input type="submit" value="Eksport to Excel" class="btn btn-primary"></a> 
<?php } ?>
