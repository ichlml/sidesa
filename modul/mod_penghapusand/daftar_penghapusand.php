        ...
        <div class="tab-pane active fade in" id="inside">
            ...
            <div class="panel panel-default">
                <div class="panel-heading"><h6 class="panel-title"><i class="icon-trash"></i>
                    Daftar Penghapusan Jalan, Irigasi dan Jaringan
...
$tampil = mysql_query("SELECT * FROM invesd, barang, subdinas, penghapusan where invesd.skpd=subdinas.kode_subdinas and barang.kode_barang=invesd.kode_barang and invesd.id_invesd = penghapusan.id_inves and subdinas.kode_subdinas = '$_SESSION[dinas]' AND barang.kode_barang = penghapusan.kode_barang order by invesd.id_invesd  DESC, invesd.register DESC") or die (mysql_error());
...
?>
  ...
  <td><?php echo"$r[nama_subdinas]"; ?></td>
                                            ...
                                            <td>
                                                <a href="./modul/mod_penghapusand/del.php?id=<?=$r['id_penghapusan']; ?>&&idinves=<?= $r['id_invesd'] ?>" onclick="return confirm('Anda Yakin ingin menghapus data ?');"><span class="icon-remove4"></span> </a>
                                            </td>
