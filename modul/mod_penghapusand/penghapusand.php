...
<div class="page-content">
    ...
    <form action="?module=hapusd" method="post">
    <!-- /page header -->
    <!-- Breadcrumbs line -->
    ...
    <div class="tabbable page-tabs">
                <ul class="nav nav-tabs">
                    ...
                    <li><a href="?module=dftrpenghapusand"><i class="icon-plus"></i> Daftar Penghapusan Jalan, Irigasi dan Jaringan</a></li>
                </ul>
...
$tampil = mysql_query("SELECT * FROM invesd, barang, subdinas where invesd.skpd=subdinas.kode_subdinas and barang.kode_barang=invesd.kode_barang and subdinas.kode_subdinas = '$_SESSION[dinas]' AND status_penggunaan=1 order by invesd.id_invesd  DESC, invesd.register DESC") or die (mysql_error());
}
$no=1;
...
?>
				                        <tr>
                                            <td> 
                                                <input type="checkbox" name="checked[]" class="check" value="<?=$r['id_invesd']?>" >
                                            </td>
                                            <td><?php echo"$no"; ?></td>
