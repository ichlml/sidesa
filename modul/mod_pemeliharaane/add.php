<div class="page-content">
	<div class="page-header">
			...
			$sql = mysql_query("SELECT * FROM invese, barang, subdinas where invese.skpd=subdinas.kode_subdinas and barang.kode_barang=invese.kode_barang  and subdinas.kode_subdinas = '$_SESSION[dinas]' and id_invese='$id' order by invese.id_invese  DESC, invese.register DESC") or die(mysql_error('koneksi gagal'));
			...
			?>
			<form method="post" action="modul/mod_pemeliharaane/aksi_pmle.php" role="form">
				<div class="block">
				<h6 class="heading-hr"><i class="icon-checkmark-circle"></i> Form Pemeliharaan Aset Tetap Lainya</h6>
				<div class="row">
					<div class="col-xs-6">
						<div class="form-group">
								...
								<input type="hidden" name="id_invese" id="id_invese" class="form-control" value="<?= $data['id_invese']?>" readonly required>
						</div>
						<div class="form-group">
                    ...
                    <table class="table">
						...
						?>
							<tr>
								...
								<td><?= $row['nilai']?></td>
								<td>
									<a href="./modul/mod_pemeliharaane/hapus.php?id=<?=$row[id_pemeliharaan]; ?>" onclick="return confirm('Anda Yakin ingin menghapus data ?');"><span class="icon-remove4"></span> </a>
								</td>
							</tr>    
						</tbody>
						<?php 
