		...
		<div class="page-content">
			...
			<div class="breadcrumb-line">
				<ul class="breadcrumb">
					...
					<li><a href="?module=keluar">Pendataan keluar</a></li>
				</ul>
            ...
            <div class="tabbable page-tabs">
                <ul class="nav nav-tabs">
                    ...
                    <li><a href="?module=keluar&act=tambahkeluar"><i class="icon-plus"></i> Tambah Data</a></li>
                </ul>
                	...
                	<div class="tab-pane active fade in" id="inside">
			           ...
			           <!-- Datatable with custom column filtering -->
			            <div class="panel panel-default">
			                <div class="panel-heading"><h6 class="panel-title"><i class="icon-table"></i> Data keluar</h6></div>
			                <div class="datatable-add-row">
				                <table class="table">
				                    ...
				                    <tbody>
<?php
                                              $tampil = mysql_query("SELECT * FROM keluar, barang where keluar.kode_barang=barang.kode_barang order by kode_keluar DESC");
  $no=1;
    while ($r=mysql_fetch_array($tampil)){
?>
											<tr>
                                            <td><?php echo"$no"; ?></td>
                                            <td><?php echo"$r[kode_keluar]"; ?></td>
				                            ...
				                            <td><center><?php echo"<a href=?module=keluar&act=editkeluar&id=$r[kode_keluar]>"; ?><span class="icon-quill2"></span> </a> &nbsp; <?php echo"<a href=$aksi?module=keluar&act=hapus&id=$r[kode_keluar]"; ?> <span class="icon-remove4"></span> </a> &nbsp; </center></td>
				                        </tr>
                                        <?php $no++; } ?>
		...
		<div class="page-content">
			...
			<div class="breadcrumb-line">
				<ul class="breadcrumb">
					<li><a href="?module=home">Home</a></li>
					<li><a href="#">Master</a></li>
					<li><a href="?module=keluar">Setup keluar</a></li>
					<li><a href="?module=keluar&tambahkeluar">Tambah keluar</a></li>
				</ul>
...
<div class="alert alert-success fade in block-inner">
                    		<button type="button" class="close" data-dismiss="alert">×</button>
                    		Data berhasil di tambahkan ke database  .... <a href="media.php?module=keluar">lihat data keluar</a>
                    	</div><?php } ?>

		    <!-- Form validation -->
            <form action="<?php echo"$aksi?module=keluar&act=input"; ?>"  method="post" enctype="multipart/form-data" class="form-horizontal validate" role="form">
	            <div class="block">
	                <h6 class="heading-hr"><i class="icon-checkmark-circle"></i> Form Tambah keluar</h6>
...
<input type="text" name="harga" id="harga" class="form-control" data-parsley-required="true" >     											  
                    ...
                    <div class="form-group">
					  ...
					  <div class="col-sm-6">
											 <label for="kode_barang" class="req">Tanggal Keluar </label>	<input name="tanggal_keluar" type="text" class="form-control" id="tanggal_keluar">
			                    	
		                      </div>
					</div>
                    <div class="form-group">
						<div class="col-sm-6">
											 <label for="kode_barang" class="req">Tanggal Kembali </label>	<input name="tanggal_kembali" type="text" class="form-control" id="tanggal_kembali">
			                    </div>
					</div>
                      <div class="form-group">
						<div class="col-sm-12">
...
<?php
  ...
  // Form Edit Kategori  
  case "editkeluar":
    $edit=mysql_query("SELECT * FROM keluar, barang, subdinas where keluar.skpd=subdinas.kode_subdinas and keluar.kode_barang=barang.kode_barang AND kode_keluar='$_GET[id]'");
...
?>
		<div class="page-content">
		    ...
		    <!-- Form validation -->
            <form class="form-horizontal validate" method="post" action="<?php echo"$aksi?module=keluar&act=update"; ?>" enctype="multipart/form-data"  role="form">
	            <div class="block">
	                <h6 class="heading-hr"><i class="icon-checkmark-circle"></i> Form Update keluar</h6>


<div class="form-group">
											
											  <div class="col-lg-6">
												<label for="kode_barang" class="req">Kode keluar </label>
											  <input name="id" type="text" class="form-control" id="id" value="<?php echo"$r[kode_keluar]"; ?>" readonly data-parsley-required="true" >								
                               				  </div>
...
<input name="harga" type="text" class="form-control" id="harga" value="<?php echo"$r[harga]"; ?>" data-parsley-required="true" >     											  
                    ...
                    <div class="form-group">
					  ...
					  <div class="col-sm-6">
											 <label for="kode_barang" class="req">Tanggal Keluar </label>	<input name="tanggal_keluar" type="text" class="form-control" id="tanggal_keluar" value="<?php echo"$r[tanggal_keluar]"; ?>">
                    ...
                    <div class="form-group">
					  ...
					  <div class="col-sm-6">
											 <label for="kode_barang" class="req">Tanggal Kembali </label>	<input name="tanggal_kembali" type="text" class="form-control" id="tanggal_kembali" value="<?php echo"$r[tanggal_kembali]"; ?>">
