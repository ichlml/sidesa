	...
	<div class="page-header">
			...
			<div class="breadcrumb-line">
				<ul class="breadcrumb">
					...
					<li><a href="?module=pemeliharaana">Pemeliharaan Jalan Irigasi dan Jaringan</a></li>
				</ul>
			...
			$sql = mysql_query("SELECT * FROM invesd, barang, subdinas where invesd.skpd=subdinas.kode_subdinas and barang.kode_barang=invesd.kode_barang  and subdinas.kode_subdinas = '$_SESSION[dinas]' and id_invesd='$id' order by invesd.id_invesd  DESC, invesd.register DESC") or die(mysql_error('koneksi gagal'));
			...
			?>
			<form method="post" action="modul/mod_pemeliharaand/aksi_pmld.php" role="form">
				<div class="block">
				<h6 class="heading-hr"><i class="icon-checkmark-circle"></i> Form Pemeliharaan Jalan Irigasi dan Jaringan</h6>
				<div class="row">
					<div class="col-xs-6">
						<div class="form-group">
								...
								<input type="hidden" name="id_invesd" id="id_invesd" class="form-control" value="<?= $data['id_invesd']?>" readonly required>
						</div>
						<div class="form-group">
                    ...
                    <table class="table">
						...
						?>
							<tr>
								...
								<td>
								<a href="./modul/mod_pemeliharaand/hapus.php?id=<?=$row[id_pemeliharaan]; ?>" onclick="return confirm('Anda Yakin ingin menghapus data ?');"><span class="icon-remove4"></span> </a>
								</td>
							</tr>    
						</tbody>
						<?php 
