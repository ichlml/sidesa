...
<div class="page-content">
    ...
    <form action="?module=hapuse" method="post">
    <!-- /page header -->
    <!-- Breadcrumbs line -->
    ...
    <div class="tabbable page-tabs">
                <ul class="nav nav-tabs">
                    ...
                    <li><a href="?module=dftrpenghapusane"><i class="icon-plus"></i> Daftar Penghapusan Tanah</a></li>
                </ul>
...
?>
				                        <tr>
                                            <td> 
                                                <input type="checkbox" name="checked[]" class="check" value="<?=$r['id_invese']?>" >
                                            </td>
                                            <td><?php echo"$no"; ?></td>
