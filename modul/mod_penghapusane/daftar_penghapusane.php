        ...
        <div class="tab-pane active fade in" id="inside">
            ...
            <div class="panel panel-default">
                <div class="panel-heading"><h6 class="panel-title"><i class="icon-trash"></i>
                    Daftar Penghapusan Aset Tetap Lainya
...
$tampil = mysql_query("SELECT * FROM invese, barang, subdinas, penghapusan where invese.skpd=subdinas.kode_subdinas and barang.kode_barang=invese.kode_barang and invese.id_invese = penghapusan.id_inves and subdinas.kode_subdinas = '$_SESSION[dinas]' AND barang.kode_barang = penghapusan.kode_barang order by invese.id_invese  DESC, invese.register DESC") or die (mysql_error());
...
?>
  ...
  <td><?php echo"$r[nama_subdinas]"; ?></td>
                                            ...
                                            <td>
                                                <a href="./modul/mod_penghapusane/del.php?id=<?=$r['id_penghapusan']; ?>&&idinves=<?= $r['id_invese'] ?>" onclick="return confirm('Anda Yakin ingin menghapus data ?');"><span class="icon-remove4"></span> </a>
                                            </td>
