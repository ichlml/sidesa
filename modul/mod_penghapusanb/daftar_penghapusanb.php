        ...
        <div class="tab-pane active fade in" id="inside">
            ...
            <div class="panel panel-default">
                <div class="panel-heading"><h6 class="panel-title"><i class="icon-trash"></i>
                    Daftar Penghapusan Mesin dan Peralatan
...
$tampil = mysql_query("SELECT * FROM invesb, barang, subdinas, penghapusan where invesb.skpd=subdinas.kode_subdinas and barang.kode_barang=invesb.kode_barang and invesb.id_invesb = penghapusan.id_inves and subdinas.kode_subdinas = '$_SESSION[dinas]' and barang.kode_bidang = penghapusan.kode_bidang order by invesb.id_invesb  DESC, invesb.register DESC") or die (mysql_error());
...
?>
  ...
  <td><?php echo"$r[nama_subdinas]"; ?></td>
                                            ...
                                            <td>
                                                <a href="./modul/mod_penghapusanb/del.php?id=<?=$r['id_penghapusan']; ?>&&idinves=<?= $r['id_invesb'] ?>" onclick="return confirm('Anda Yakin ingin menghapus data ?');"><span class="icon-remove4"></span> </a>
                                            </td>
