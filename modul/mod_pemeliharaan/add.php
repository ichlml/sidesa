	...
	<div class="page-header">
			...
			<div class="breadcrumb-line">
				<ul class="breadcrumb">
					...
					<li><a href="?module=pemeliharaana">Pemeliharaan Tanah</a></li>
				</ul>
			...
			$sql = mysql_query("SELECT * FROM invesa, barang, subdinas where invesa.skpd=subdinas.kode_subdinas and barang.kode_barang=invesa.kode_barang and subdinas.kode_subdinas = '$_SESSION[dinas]' AND id_invesa='$id' order by invesa.id_invesa  DESC, invesa.register DESC") or die(mysql_error('koneksi gagal'));
			...
			?>
			<form method="post" action="modul/mod_pemeliharaan/aksi_pemba.php" role="form">
				<div class="block">
				<h6 class="heading-hr"><i class="icon-checkmark-circle"></i> Form Pemeliharaan Tanah</h6>
				<div class="row">
					<div class="col-xs-6">
						<div class="form-group">
								...
								<input type="hidden" name="id_invesa" id="id_invesa" class="form-control" value="<?= $data['id_invesa']?>" readonly required>
						</div>
						<div class="form-group">
                    ...
                    <table class="table">
						...
						?>
							<tr>
								...
								<td>
								<a href="./modul/mod_pemeliharaan/hapus.php?id=<?=$row[id_pemeliharaan]; ?>" onclick="return confirm('Anda Yakin ingin menghapus data ?');"><span class="icon-remove4"></span> </a>
								</td>
							</tr>    
						</tbody>
						<?php 
