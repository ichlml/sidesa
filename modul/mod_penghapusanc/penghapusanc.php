...
<div class="page-content">
    ...
    <form action="?module=hapusc" method="post">
    <!-- /page header -->
    <!-- Breadcrumbs line -->
    ...
    <div class="tabbable page-tabs">
                <ul class="nav nav-tabs">
                    ...
                    <li><a href="?module=dftrpenghapusanc"><i class="icon-plus"></i> Daftar Penghapusan Gedung dan Bangunan</a></li>
                </ul>
...
?>
				                        <tr>
                                            <td> 
                                                <input type="checkbox" name="checked[]" class="check" value="<?=$r['id_invesc']?>" >
                                            </td>
                                            <td><?php echo"$no"; ?></td>
