        ...
        <div class="tab-pane active fade in" id="inside">
            ...
            <div class="panel panel-default">
                <div class="panel-heading"><h6 class="panel-title"><i class="icon-trash"></i>
                    Daftar Penghapusan Gedung dan Bangunan
...
$tampil = mysql_query("SELECT * FROM invesc, barang, subdinas, penghapusan where invesc.skpd=subdinas.kode_subdinas and barang.kode_barang=invesc.kode_barang and invesc.id_invesc = penghapusan.id_inves and subdinas.kode_subdinas = '$_SESSION[dinas]' AND barang.kode_bidang = penghapusan.kode_bidang order by invesc.id_invesc  DESC, invesc.register DESC") or die (mysql_error());
...
?>
  ...
  <td><?php echo"$r[nama_subdinas]"; ?></td>
                                            ...
                                            <td>
                                                <a href="./modul/mod_penghapusanc/del.php?id=<?=$r['id_penghapusan']; ?>&&idinves=<?= $r['id_invesc'] ?>" onclick="return confirm('Anda Yakin ingin menghapus data ?');"><span class="icon-remove4"></span> </a>
                                            </td>
