...
<center>	<h3>Laporan Aset Tanah ( KIS ) <br/><small>KARTU INVENTARIS BARANG </small></h3></center>
	  ...
	  <tr>
	    ...
	    <td bgcolor="#cccccc" align="center"><font face="Arial Narrow" size="1">15</font></td>		
				...
				<?php
                                              $tampil = mysql_query("SELECT * FROM invesa, barang, subdinas where invesa.skpd=subdinas.kode_subdinas and barang.kode_barang=invesa.kode_barang order by kode_invesa DESC") or die (mysql_error());
  $no=1;
