...
if($halaman_aktif > 1){
	$prev = $halaman_aktif-1;
	$link_halaman .= "<a href=$_SERVER[PHP_SELF]?module=$_GET[module]&act=cari&skpd=$_GET[skpd]&halaman=1><< First</a> | 
                    <a href=$_SERVER[PHP_SELF]?module=$_GET[module]&act=cari&skpd=$_GET[skpd]&halaman=$prev>< Prev</a> | ";
}
else{ 
	$link_halaman .= "<< First | < Prev | ";
}
...
for ($i=$halaman_aktif-2; $i<$halaman_aktif; $i++){
  if ($i < 1)
  	continue;
	  $angka .= "<a href=$_SERVER[PHP_SELF]?module=$_GET[module]&act=cari&skpd=$_GET[skpd]&halaman=$i>$i</a> | ";
  }
	  $angka .= " <b>$halaman_aktif</b> | ";
    ...
    if($i > $jmlhalaman)
	  ...
	  $angka .= ($halaman_aktif+2<$jmlhalaman ? " ... | <a href=$_SERVER[PHP_SELF]?module=$_GET[module]&act=cari&skpd=$_GET[skpd]&halaman=$jmlhalaman>$jmlhalaman</a> | " : " ");
...
if($halaman_aktif < $jmlhalaman){
	$next = $halaman_aktif+1;
	$link_halaman .= " <a href=$_SERVER[PHP_SELF]?module=$_GET[module]&act=cari&skpd=$_GET[skpd]&halaman=$next>Next ></a> | 
                     <a href=$_SERVER[PHP_SELF]?module=$_GET[module]&act=cari&skpd=$_GET[skpd]&halaman=$jmlhalaman>Last >></a> ";
}
else{
	$link_halaman .= " Next > | Last >>";
}
...
if($halaman_aktif > 1){
	$prev = $halaman_aktif-1;
	$link_halaman .= "<a href=$_SERVER[PHP_SELF]?module=$_GET[module]&act=sumber&sumber=$_GET[sumber]&halaman=1><< First</a> | 
                    <a href=$_SERVER[PHP_SELF]?module=$_GET[module]&act=sumber&sumber=$_GET[sumber]&halaman=$prev>< Prev</a> | ";
}
else{ 
	$link_halaman .= "<< First | < Prev | ";
}
...
for ($i=$halaman_aktif-2; $i<$halaman_aktif; $i++){
  if ($i < 1)
  	continue;
	  $angka .= "<a href=$_SERVER[PHP_SELF]?module=$_GET[module]&act=sumber&sumber=$_GET[sumber]&halaman=$i>$i</a> | ";
  }
	  $angka .= " <b>$halaman_aktif</b> | ";
    ...
    if($i > $jmlhalaman)
	  ...
	  $angka .= ($halaman_aktif+2<$jmlhalaman ? " ... | <a href=$_SERVER[PHP_SELF]?module=$_GET[module]&act=sumber&sumber=$_GET[sumber]&halaman=$jmlhalaman>$jmlhalaman</a> | " : " ");
...
if($halaman_aktif < $jmlhalaman){
	$next = $halaman_aktif+1;
	$link_halaman .= " <a href=$_SERVER[PHP_SELF]?module=$_GET[module]&act=sumber&sumber=$_GET[sumber]&halaman=$next>Next ></a> | 
                     <a href=$_SERVER[PHP_SELF]?module=$_GET[module]&act=sumber&sumber=$_GET[sumber]&halaman=$jmlhalaman>Last >></a> ";
}
else{
	$link_halaman .= " Next > | Last >>";
}
...
if($halaman_aktif > 1){
	$prev = $halaman_aktif-1;
	$link_halaman .= "<a href=$_SERVER[PHP_SELF]?module=$_GET[module]&act=cari&halaman=1&bidang=$_GET[propinsi]&barang=$_GET[kota]&skpd=$_GET[skpd]&tahun=$_GET[tahun]><< First</a> | 
                    <a href=$_SERVER[PHP_SELF]?module=$_GET[module]&act=cari&halaman=$prev&bidang=$_GET[propinsi]&barang=$_GET[kota]&skpd=$_GET[skpd]&tahun=$_GET[tahun]>< Prev</a> | ";
}
else{ 
	$link_halaman .= "<< First | < Prev | ";
}
...
for ($i=$halaman_aktif-2; $i<$halaman_aktif; $i++){
  if ($i < 1)
  	continue;
	  $angka .= "<a href=$_SERVER[PHP_SELF]?module=$_GET[module]&act=cari&halaman=$i&bidang=$_GET[propinsi]&barang=$_GET[kota]&skpd=$_GET[skpd]&tahun=$_GET[tahun]>$i</a> | ";
  }
	  $angka .= " <b>$halaman_aktif</b> | ";
    ...
    if($i > $jmlhalaman)
	  ...
	  $angka .= ($halaman_aktif+2<$jmlhalaman ? " ... | <a href=$_SERVER[PHP_SELF]?module=$_GET[module]&act=cari&halaman=$jmlhalaman&bidang=$_GET[propinsi]&barang=$_GET[kota]&skpd=$_GET[skpd]&tahun=$_GET[tahun]>$jmlhalaman</a> | " : " ");
...
if($halaman_aktif < $jmlhalaman){
	$next = $halaman_aktif+1;
	$link_halaman .= " <a href=$_SERVER[PHP_SELF]?module=$_GET[module]&act=cari&halaman=$next&bidang=$_GET[propinsi]&barang=$_GET[kota]&skpd=$_GET[skpd]&tahun=$_GET[tahun]>Next ></a> | 
                     <a href=$_SERVER[PHP_SELF]?module=$_GET[module]&act=cari&halaman=$jmlhalaman&bidang=$_GET[propinsi]&barang=$_GET[kota]&skpd=$_GET[skpd]&tahun=$_GET[tahun]>Last >></a> ";
}
else{
	$link_halaman .= " Next > | Last >>";
}
